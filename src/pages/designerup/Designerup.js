...
export default function Designerup() {
     ...
     <div className='grid gap-x-6 grid-cols-2 mx-20 p-6 my-6 w-4/5'>
      ...
      <div className='relative flex justify-center items-center'>
        ...
        <Link className='font-semibold relative mt-4'>Name</Link>
          <div className='flex ml-auto mr-0 items-center  text-gray-100 hover:bg-opacity-75 rounded-md m-2 p-1 bg-gray-400'>
              <button className='flex items-center justify-center font-semibold w-24 h-10 text-center'>Edit Profile</button>
          </div>
        </div>
