...
//                 <Link className="ImgBar" to="/">
//                     <img src='image/Gemarii Favicon.png'alt='' height={200} width={250}/>
...
//                         <Link className="link" to="/lgndesigner">
//                             HOME
//                         </Link>
//                     </li>
//                     <li className="topListItem">
...
//                     </li>
//             </ul> 
//             <ul className="aturBahasa">
//                 <li className="indL">IN</li>
//                 <li className="engL">EN</li>
//             </ul>
//             </div>
//         </div>
//     )
