  ...
  return (
    <div className='flex relative items-center mr-2'>
        ...
        <div className='mt-0 flex items-center'>
           <input type="text" className="py-2 pl-2 pr-2 w-[300px]  border rounded-md dark:bg-gray-100 dark:text-gray-700 dark:border-gray-600 focus:border-blue-400 dark:focus:border-gray-900 focus:ring-black focus:ring-opacity-40 focus:outline-none focus:ring" placeholder="Search"/>
        </div>
