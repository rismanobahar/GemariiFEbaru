  ...
  return (
    <div className='flex relative items-center mr-2'>
        ...
        <div className="relative flex p-6 items-center">
            <Link  to="/" spy={true} smooth={true} offset={-100} duration={500} type='button' className="text-[20px] font-extrabold text-black hover:text-gray-600  transition duration-300 border-b-4 border-transparent hover:no-underline hover:border-gray-600 sm:mx-6 ">Home</Link>
