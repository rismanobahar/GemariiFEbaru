...
export default function BhsDropdown() {
  return (
    <div className="relative w-auto right-5" >
      <Menu as="div" className="inline-block text-left">
        <div>
          <Menu.Button className="inline-flex justify-center w-full h-auto p-1 text-sm font-semibold text-gray-700 bg-gray-600 rounded-md bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            <img
              alt="United Kingdom"
              src="http://purecatamphetamine.github.io/country-flag-icons/3x2/GB.svg"
              className='ml-0 mr-auto p-1 rounded-full'
              height={10} width={30}
              />
              EN 
              <ChevronDownIcon
